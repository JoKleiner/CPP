...
/*   Updated: 2025/09/04 10:34:41 by joklein          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (m_hit_points <= 0)	
		return (std::cout << m_name << " is out of hit-points" << std::endl, void());
		
	if (m_energy_points <= 0)
		return (std::cout << m_name << " is out of energy-points" << std::endl, void());
		
	std::cout << m_name << " repaires " << amount << " Hit-points!" << std::endl;
	m_hit_points += amount;
	m_energy_points--;
	std::cout << m_name << " | hit-points: " << m_hit_points << ", energy-points: " << m_energy_points << std::endl;
}
