...
/*   Updated: 2025/09/04 10:38:47 by joklein          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (m_hit_points <= 0)
		return (std::cout << "FragTrap " << m_name << " is out of hit-points" << std::endl, void());
		
	if (m_energy_points <= 0)
		return (std::cout << "FragTrap " << m_name << " is out of energy-points" << std::endl, void());
